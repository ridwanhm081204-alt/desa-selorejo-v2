                            ...
                            @if(isset($layanan) && $layanan->syarat)
                                @foreach($layanan->syarat as $syarat)
                                    ...
                                    <div class="{{ $isHilang ? 'col-md-6 d-none animate-fade-in' : 'col-md-6' }}" {!! $isHilang ? 'id="surat_kehilangan_file_container"' : '' !!}>
                                        ...
                                        <input type="file" name="{{ $syarat->kode_syarat }}" {!! $isHilang ? 'id="file_surat_kehilangan"' : '' !!} class="form-control rounded-pill border-0 shadow-sm bg-white" accept="image/*,.heic,.heif,application/pdf" {{ $syarat->is_required ? 'required' : '' }}>
