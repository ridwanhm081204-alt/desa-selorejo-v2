        ...
        <div class="col-lg-10">
            <div class="glass-card bg-white p-0 rounded-4 shadow-lg overflow-hidden border-0 mb-5">
                ...
                <div class="position-relative">
                    <img src="{{ !empty($profile->sejarah_image) ? asset($profile->sejarah_image) : asset('images/SelorejoWaduk.jpg') }}" onerror="this.src='{{ asset('images/SelorejoWaduk.jpg') }}'" alt="Pemandangan Desa Selorejo" class="img-fluid w-100" style="max-height: 500px; object-fit: cover;">
