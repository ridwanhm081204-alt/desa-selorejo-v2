...
<div class="container mb-5 pb-5">
    <div class="row g-4 justify-content-center">
        ...
        <!-- Misi List -->
        <div class="col-lg-10">
            <div class="glass-card bg-white p-4 p-md-5 rounded-4 shadow-sm border-0 position-relative" style="border-top: 5px solid var(--color-forest) !important;">
                <div class="text-center mb-5">
                    <span class="badge px-3 py-2 rounded-pill fw-bold mb-3" style="background-color: var(--color-forest) !important; color: #fff !important; font-family: var(--font-body);">MISI KAMI</span>
                    <h3 class="fw-bold text-dark" style="font-family: var(--font-heading);">Langkah Strategis Pembangunan</h3>
                </div>
                ...
                <div class="row g-4 mt-2 justify-content-center">
                    @foreach($misiArray as $m)
                        <div class="col-md-6 col-lg-6">
                            <div class="d-flex align-items-start card-hover h-100 p-4 rounded-4 bg-light border border-opacity-10 shadow-sm" style="border-color: var(--color-forest) !important;">
                                ...
                                <div class="flex-grow-1">
                                    <p class="text-dark fw-bold mb-0 lh-lg" style="font-size: 0.95rem; font-family: var(--font-body);">{{ $m['text'] }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
