        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm card-hover bg-white rounded-4 overflow-hidden d-flex flex-column">
                <div class="position-relative">
                    <img src="{{ $p->gambar ? asset('storage/'.$p->gambar) : 'https://images.unsplash.com/photo-1560472355-536de3962603?w=400&q=80' }}" class="card-img-top w-100 img-cover" style="height: 220px;" alt="{{ $p->nama }}">
                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <p class="text-muted small text-truncate-2 flex-grow-1 mb-4">{{ Str::limit($p->deskripsi, 80) }}</p>
