    ...
    <div class="card-body p-4">
        <form action="{{ isset($produk) ? url('/operator/produk/'.$produk->id) : url('/operator/produk') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    <label class="form-label fw-bold">Jumlah Stok (Pcs)</label>
                    <input type="number" name="stok" class="form-control" value="{{ old('stok', $produk->stok ?? '100') }}" placeholder="Contoh: 100" min="0" required>
                </div>
            </div>
