    ...
    <div class="col-lg-6 col-md-8">
        <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white border-top border-4 border-success">
            <div class="d-flex align-items-center mb-5 border-bottom pb-4">
                ...
                <div>
                    <h5 class="fw-bold mb-0 text-dark">Tambah Data Statistik</h5>
                    <small class="text-muted">Input parameter demografi penduduk baru</small>
                </div>
            </div>
            ...
            <form action="{{ route('operator.statistik.store') }}" method="POST">
                ...
                <div class="d-grid gap-2 mt-5">
                    <button type="submit" class="btn btn-success py-3 rounded-pill fw-bold shadow-sm hover-lift border-0">
                        <i data-lucide="save" class="me-2 icon-sm"></i> SIMPAN DATA STATISTIK
                    </button>
