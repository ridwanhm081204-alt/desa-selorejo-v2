    ...
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden" style="width: 420px; background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px);">
        ...
        <div class="card-body p-4 p-md-5 text-center">
            <div class="mb-5">
                ...
                <h4 class="fw-bold text-dark mb-1">E-Government Selorejo</h4>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-4 text-start">
                    ...
                    <div class="input-group bg-light rounded-3 overflow-hidden border border-success border-opacity-10">
                        <span class="input-group-text bg-transparent border-0"><i data-lucide="mail" class="icon-sm text-success opacity-50"></i></span>
                        <input type="email" name="email" class="form-control border-0 bg-transparent shadow-none py-2" placeholder="nama@selorejo.id" required autofocus>
                    </div>
                </div>
                ...
                <div class="mb-4 text-start">
                    ...
                    <div class="input-group bg-light rounded-3 overflow-hidden border border-success border-opacity-10">
                        <span class="input-group-text bg-transparent border-0"><i data-lucide="lock" class="icon-sm text-success opacity-50"></i></span>
                        <input type="password" name="password" id="password-input" class="form-control border-0 bg-transparent shadow-none py-2" placeholder="••••••••" required>
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    <div class="form-check">
                        <input class="form-check-input shadow-none border-success border-opacity-25" type="checkbox" name="remember" id="remember">
                ...
                @if($errors->any())
                    <div class="alert alert-danger border-0 rounded-3 p-2 mb-4 animate-shake">
                ...
                <button type="submit" class="btn btn-success w-100 rounded-pill py-2 fw-bold shadow-sm hover-lift border-0 mt-2" style="background: linear-gradient(change, #2d6a4f, #1b4332) !important;">
                    MASUK KE DASHBOARD
                </button>
            </form>

            <div class="mt-5 text-muted small border-top pt-4">
