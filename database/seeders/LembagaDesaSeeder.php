...
class LembagaDesaSeeder extends Seeder {
    public function run() {
        ...
        $data = [
            ['nama_lembaga'=>'LPMD','jenis'=>'LPMD','ketua'=>'Pardi Susanto','deskripsi'=>'Lembaga Pemberdayaan Masyarakat Desa Selorejo bertugas merencanakan dan menggerakkan swadaya gotong royong masyarakat dalam pelaksanaan pembangunan.'],
